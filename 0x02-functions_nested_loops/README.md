The following projects focuses on the following tasks;
1. Writting a program that prints _putchar
2. Writting a function that prints the alphabet, in lowercase, followed by a new line.
